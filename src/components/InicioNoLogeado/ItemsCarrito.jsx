        ...
        <div>
            <div className="flex">
                ...
                <item key={producto.id} className="flex mt-3">
                    ...
                    <div className="ml-3">
                        <h1 className="mt-2 font-bold text-lg sm:text-xl md:text-xl xl:text-2xl">{producto.nombre}</h1>
                        <p className="text-base sm:text-lg md:text-lg xl:text-xl">{producto.descripcion}</p>
                        <p className={producto.idTalla == 7 ? "hidden" : "text-base sm:text-lg md:text-lg xl:text-xl font-medium"}>Talla: </p>
